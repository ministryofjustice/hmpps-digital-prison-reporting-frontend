import { defaultMockRequest, generateNetworkMock, reportIdRegex, setupSimpleFailedMock } from "@networkMocks/generateNetworkMock";
...
export const dashboardApiFailures = {
  ...
  getAsyncDashboardFailure: setupSimpleFailedMock(`/reports/${reportIdRegex}/dashboards/${reportIdRegex}/tables/${reportIdRegex}/result`),
  getAsyncDashboardStatusFailure: setupSimpleFailedMock(`/reports/${reportIdRegex}/dashboards/${reportIdRegex}/statements/edIx_[0-9]+/status`),
