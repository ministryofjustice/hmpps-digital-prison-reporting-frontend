...
import { partialDataSetNoTs } from './data_no-ts'
...
export const dashboardResultPartialDataNoTsMock = setupSimpleMock(
  `/reports/(${productIds.join('|')})/dashboards/(${noTs.join('|')})/tables/tblId_[0-9]+/result`,
  partialDataSetNoTs,
)
...
export const mocks = [
  ...
  dashboardResultPartialDataNoTsMock,
]
