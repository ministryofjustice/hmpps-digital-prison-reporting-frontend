import { ReportType, RequestedReport, RequestStatus } from '../../../dpr/types/UserReports'
...
export const requestedReady: RequestedReport = {
  ...
  timestamp: {
    requested: new Date('2024-10-24T10:27:09.173Z'),
    completed: new Date('2024-10-24T10:27:15.448Z'),
  },
...
export const requestedExpired: RequestedReport = {
  ...
  timestamp: {
    requested: new Date('2024-10-24T10:31:12.861Z'),
    completed: new Date('2024-10-24T10:31:22.225Z'),
    expired: new Date('2024-10-24T10:31:22.313Z'),
  },
  executionId: 'exId_238947923',
...
export const requestedAborted: RequestedReport = {
  ...
  timestamp: {
    requested: new Date('2024-10-24T10:33:34.078Z'),
    aborted: new Date('2024-10-24T10:33:35.430Z'),
  },
  executionId: 'exId_238947923',
...
export const requestedFailed: RequestedReport = {
  ...
  name: 'Failing report',
  timestamp: {
    requested: new Date('2024-10-24T10:28:15.792Z'),
    failed: new Date('2024-10-24T10:28:22.013Z'),
  },
  executionId: 'exId_238947923',
  ...
  errorMessage: 'An error has occurred for some reason - Status API returned Failed Status',
}
