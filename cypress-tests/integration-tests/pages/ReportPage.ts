...
export default class ReportPage {
  ...
  showColumnsButton = (): PageElement =>
    cy.xpath(`//*[@id="main-content"]/div/div/div[2]/div[1]/div[1]/div/details/summary`)

  resetFilterButton = (): PageElement => cy.xpath(`//*[@id="interactive-reset-filters-button"]`)

  resetColumnsButton = (): PageElement =>
    cy.xpath(`//*[@id="main-content"]/div/div/div[2]/div[1]/div[1]/div/details/div/form/div[2]/a`)
  ...
  applyColumnsButton = (): PageElement =>
    cy.xpath(`//*[@id="main-content"]/div/div/div[2]/div[1]/div[1]/div/details/div/form/div[2]/button`)
  ...
  selectedFilterButtonField1 = (): PageElement =>
    cy.xpath(`//*[@id="main-content"]/div/div/div[2]/div[1]/div[2]/div/div/a[1]`)

  selectedFilterButtonField7 = (): PageElement =>
    cy.xpath(`//*[@id="main-content"]/div/div/div[2]/div[1]/div[2]/div/div/a[3]`)

  selectedFilterButtonField3 = (): PageElement =>
    cy.xpath(`//*[@id="main-content"]/div/div/div[2]/div[1]/div[2]/div/div/a[2]`)
