...
Then('the url is set to the default values', () => {
  cy.url().should(
    'eq',
    'http://localhost:3010/embedded/platform/dpr/request-report/report/request-examples/request-example-success/filters?sortColumn=field2&sortedAsc=false&filters.field1=value1.2&filters.field3.start=2003-02-01&filters.field3.end=2006-05-04&filters.field7=2005-02-01&filters.field8=value8.2&filters.field8=value8.3',
  )
})
...
Then('the URL is updated', () => {
  cy.url().should(
    'eq',
    'http://localhost:3010/embedded/platform/dpr/request-report/report/request-examples/request-example-success/filters?filters.field1=value1.1&filters.field3.start=2003-02-01&filters.field3.end=2006-05-04&filters.field7=2005-02-01&filters.field8=value8.2&filters.field8=value8.3&sortColumn=field2&sortedAsc=false',
  )
})
...
Then('I am take to the polling page', () => {
  cy.url().should(
    'include',
    'http://localhost:3010/embedded/platform/dpr/request-report/report/request-examples/request-example-success/exId_',
  )
})
