...
Then('the url is set to the default values', () => {
  cy.url().should(
    'eq',
    'http://localhost:3010/dpr/request-report/report/test-report-3/variantId-1/filters?sortColumn=field2&sortedAsc=true&filters.field1=value1.2&filters.field3.start=2003-02-01&filters.field3.end=2006-05-04&filters.field7=2005-02-01&filters.field8=value8.2&filters.field8=value8.3',
  )
})
