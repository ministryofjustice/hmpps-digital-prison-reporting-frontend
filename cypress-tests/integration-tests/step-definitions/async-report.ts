...
Then('the URL will show the correct columns', () => {
  cy.url().should(
    'eq',
    'http://localhost:3010/dpr/view-report/async/report/request-examples/request-example-success/tblId_1729766362362/report?columns=field1&columns=field2&columns=field3&columns=field6&columns=field4&columns=field5',
  )
})
...
Then('the URL will show the default columns', () => {
  cy.url().should(
    'eq',
    'http://localhost:3010/dpr/view-report/async/report/request-examples/request-example-success/tblId_1729766362362/report?columns=field1&columns=field2&columns=field3&columns=field6&columns=field7',
  )
})
