...
Then('I am taken to the query page for the viewed dashboard', () => {
  cy.url().should(
    'eq',
    'http://localhost:3010/async/dashboard/test-report-3/variantId-1/request?filters.field1=value1.3&filters.field2=value2.3&filters.field3.start=2003-09-05&filters.field3.end=2007-05-01&filters.field7=2007-05-04&sortColumn=field1&sortedAsc=true&filters.field4=Inigo+Montoya',
  )
})
