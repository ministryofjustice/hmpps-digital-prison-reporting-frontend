...
import { createMockData } from './mockAsyncData'
const mockParentChild = require('../../../_networkMocks/report/mockVariants/data/parent-child')
const mockListSection = require('../../../_networkMocks/report/mockVariants/data/list-section')
const mockParentChildSection = require('../../../_networkMocks/report/mockVariants/data/parent-child-section')
const mockRowSectionChild = require('../../../_networkMocks/report/mockVariants/data/row-section-child')
const mockRowSectionData = require('../../../_networkMocks/report/mockVariants/data/row-section')
const mockRowSectionDataMultiple = require('../../../_networkMocks/report/mockVariants/data/row-section_multiple_rows')
const mockRowSectionChildDataMultiple = require('../../../_networkMocks/report/mockVariants/data/row-section-child_multiple-rows')
const mockRowSectionIncidentReport = require('../../../_networkMocks/report/mockVariants/data/row-section_incident_report')
