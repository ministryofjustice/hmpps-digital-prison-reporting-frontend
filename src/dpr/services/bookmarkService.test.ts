...
describe('BookmarkService', () => {
  ...
  <label id="variant-id-report-id-context-id-bookmark-label" for='report-id-variant-id-context-id'><span class="dpr-bookmark-label govuk-body-s">Add bookmark</span></label>
</div>`)
    })
  })
})
