...
const { establishmentAutoCompleteMulti } = require('@networkMocks/report/mockVariants/filter-input-examples/autocompleteMulti')

module.exports = [granularDateRange, relativeDateRange, relativeDateRangeDefault, establishmentsAutocomplete, establishmentsAutocompleteMulti]
