const viewedReady = {
  ...
  url: {
    ...
    request: {
      fullUrl:
        'http://localhost:3010/async-reports/test-report-3/variantId-1/request?filters.field1=value1.1&filters.field2=value2.2&filters.field3.start=2004-02-01&filters.field3.end=2006-08-04&filters.field7=2003-02-01&sortColumn=field1&sortedAsc=true&filters.field6=Value+6.1',
      search:
    ...
    report: {
      fullUrl: 'http://localhost:3010/async-reports/test-report-3/variantId-1/request/tblId_1729766362362/report',
    },
  },
  timestamp: {
...
const viewedExpired = {
  ...
  url: {
    ...
    request: {
      ...
      search:
        '?filters.field1=value1.3&filters.field2=value2.3&filters.field3.start=2003-09-05&filters.field3.end=2007-05-01&filters.field7=2007-05-04&sortColumn=field1&sortedAsc=true&filters.field4=Inigo+Montoya',
    },
    report: {
      fullUrl: 'http://localhost:3010/async-reports/test-report-3/variantId-1/request/tblId_1729766465228/report',
    },
  },
  timestamp: {
