      ...
      tableData: {
        rows: [
          [
            ...
            {
              html: "<ul class='dpr-card-group__item__filters-list govuk-!-margin-top-0 govuk-!-margin-bottom-0'><li class='govuk-body-s dpr-query-summary'><strong>Field 1:</strong> value1.3</li><li class='govuk-body-s dpr-query-summary'><strong>Field 2:</strong> value2.3</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Column:</strong> Field 1</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Direction:</strong> Ascending</li></ul>",
            },
            {
          ...
          [
            ...
            {
              html: "<ul class='dpr-card-group__item__filters-list govuk-!-margin-top-0 govuk-!-margin-bottom-0'><li class='govuk-body-s dpr-query-summary'><strong>Field 1:</strong> value1.3</li><li class='govuk-body-s dpr-query-summary'><strong>Field 2:</strong> value2.1</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Column:</strong> Field 1</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Direction:</strong> Ascending</li></ul>",
            },
            {
          ...
          [
            ...
            {
              html: "<ul class='dpr-card-group__item__filters-list govuk-!-margin-top-0 govuk-!-margin-bottom-0'><li class='govuk-body-s dpr-query-summary'><strong>Field 4:</strong> Inigo Montoya</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Column:</strong> Field 1</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Direction:</strong> Ascending</li></ul>",
            },
            {
      ...
      tableData: {
        rows: [
          [
            ...
            {
              html: "<ul class='dpr-card-group__item__filters-list govuk-!-margin-top-0 govuk-!-margin-bottom-0'><li class='govuk-body-s dpr-query-summary'><strong>Field 1:</strong> value1.1</li><li class='govuk-body-s dpr-interactive-query-summary'><strong>Field 2:</strong> value2.2</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Column:</strong> Field 1</li><li class='govuk-body-s dpr-query-summary'><strong>Sort Direction:</strong> Ascending</li></ul>",
            },
            {
              html: "<strong class='govuk-tag dpr-request-status-tag govuk-tag--grey'>EXPIRED</strong>",
              classes: 'dpr-req-cell dpr-req-cell__status',
